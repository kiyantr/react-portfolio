...
function App() {
      ...
      <Container>
        <Row>
          ...
          <Col lg={3} xs={12} style={{ paddingRight: 0 }}>
            ...
            <Row className='' style={{ paddingLeft: 15 }}>
            ...
            <Row className='justify-content-md-center'>
              ...
              <Col md={12} xs={12}>
                ...
                <Row>
                  ...
                  <Col md={11} xs={11} className='p0'>
                    <a
                      href='https://kiettran.tramcrypto.com'
                      title='CV Tran Vu Kiet'
                    >
                      kiettran.tramcrypto.com
                    </a>
                  </Col>
                </Row>
                <Row>
          ...
          <div className='position'>Fullstack Developer</div>
            <div className='summary'>
              ...
              using .NET Core, NodeJS and ReactJS. Proven ability to design,
              develop, and implement high-performance, scalable, and
              maintainable web applications. Expertise in all aspects of the
              fullstack development process, including front-end development,
              back-end development, and DevOps. Strong understanding of NodeJS
              and .NET Core, ReactJS, TypeScript, and related web technologies.
              ...
              of a team. Strong communication skills and hard working. I am
              willing to learn new programming languages, looking for long term
              commitment.
            </div>
            {/* <div>
            ...
            <div className='summary'>
              Favorites: read books, algorithms, math, AI.
            </div>
  ...
  function Skills() {
    const leftSkills = [
      {
        type: 'Backend',
        skills: ['C# .NET core', 'TypeScript NodeJS, NextJS'],
      ...
      {
        type: 'Framework',
        skills: ['.NET core version: 3.1, 5, 6, 7, 8', 'Express, Fastify'],
      },
      {
        type: 'Unit Testing',
        skills: ['NUnit, XUnit, Integration Test'],
      },
    ];
    const rightSkills = [
      {
      ...
      {
        type: 'Message broker',
        skills: ['Azure service bus, AWS SNS - SQS, RabbitMQ'],
      },
      {
        type: 'CI/CD',
        skills: ['Azure pipeline, Jenkins, Git Action'],
      },
      {
        type: 'Hosting',
        skills: ['Cloudflare'],
